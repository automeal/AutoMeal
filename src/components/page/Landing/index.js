  ...
  <div className="Landing">
    ...
    <div className="Landing__data">
      <div className="Landing__data__content">
        ...
        <div><Button type="accent" link={true} path="/register" className="Landing__data__button">Register</Button></div>
        <div><Button type ="accent" link = {true} path="/login" className ="Landing_data_button">Login</Button></div>
      </div>
    </div>
  </div>
);
