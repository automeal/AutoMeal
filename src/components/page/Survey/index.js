          ...
          <div className="Survey__content">
            ...
            <form>
              <Tabs defaultIndex={0} ref = {component => {this.tabs = component}} className="Survey__tabs">
                ...
                <Tab heading="5" >
                  <h2>Intolerances?</h2>
                  <CheckboxGroup data={intoleranceSpec} toggleHandler={this.handleIntolerances} isCheckedState={this.state.intolerances} ></CheckboxGroup>
                  <div className="Survey__goto">
                    <Button name="back" onClick={this.goTo} className="Survey__goto__button--back">Back</Button>
                    <Button name="next" onClick={this.goTo} className="Survey__goto__button--next">Next</Button>
                  </div>
                ...
                <Tab heading="6">
                  ...
                  <Select name="personCount" value={this.state.personCount} handler={this.handleSelect} options={selectOpt.personCount} />
                  <div className="Survey__goto">
                    <Button name="back" onClick={this.goTo} className="Survey__goto__button--back">Back</Button>
                    <Button type="accent"link = {true} path ="/home-page" className="Survey__goto__button--next">Done</Button>
                  </div>
                </Tab>
              </Tabs>
            </form>
